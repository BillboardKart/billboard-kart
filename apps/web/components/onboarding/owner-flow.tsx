...
export function OwnerFlow({ selectedRole, onBackAction }: OwnerFlowProps) {
  ...
  const handleCompleteOnboarding = async () => {
    try {
      ...
      // WARNING: Change this for owner role
      router.push("/account");
    } catch (error) {
      console.error(error);
    } finally {
  ...
  return (
    <div className="space-y-8">
      ...
      <SectionTitle
        title="Billboard owner onboarding"
        description="Tell us about your business so we can verify your account and help you publish billboard listings."
      />
      ...
      <div className="space-y-6">
        ...
        <FormInput
          label="Business name"
          placeholder="Skyline Media Pvt Ltd"
          value={businessName}
